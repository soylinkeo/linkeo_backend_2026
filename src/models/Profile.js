...
const ThemeSchema = new mongoose.Schema(
  {
    ...
    avatarShape:           { type: String, enum: ["circle", "banner", "rect"], default: "circle" },
    avatarPosX:            { type: Number, default: 50 },
    avatarPosY:            { type: Number, default: 50 },
    avatarZoom:            { type: Number, default: 120 },
    avatarHeight:          { type: Number, default: 160 },
    avatarRadius:          { type: Number, default: 0 },
    avatarGradientOpacity: { type: Number, min: 0, max: 1, default: 0.55 },
    avatarRectSize:        { type: Number, default: 110 },
    avatarRectRadius:      { type: Number, default: 16 },
    ...
    showVCard:        { type: Boolean, default: true },
  },
  { _id: false }
);
