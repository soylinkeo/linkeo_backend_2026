...
avatarShape:           Joi.string().valid("circle", "banner", "rect").default("circle"),
avatarPosX:            Joi.number().min(0).max(100).default(50),
avatarPosY:            Joi.number().min(0).max(100).default(50),
avatarZoom:            Joi.number().min(80).max(300).default(120),
avatarHeight:          Joi.number().min(60).max(400).default(160),
avatarRadius:          Joi.number().min(0).max(60).default(0),
avatarGradientOpacity: Joi.number().min(0).max(1).default(0.55),
avatarRectSize:        Joi.number().min(60).max(300).default(110),
avatarRectRadius:      Joi.number().min(0).max(100).default(16),
